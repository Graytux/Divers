...
if [ $# -lt 2 ]; then
	...
	echo "ex: ./PRD_Livraison_ARK-KENGO.sh AAAAMMJJ Vx.x.x";
	exit 2;
fi
...
cd /app/tomcat/logs/; rm -fr *; cd /app/tomcat/work/; rm -fr; cd /app/tomcat/temp/; rm -fr *; cd /app/tomcat/webapps/; rm -fr 'kengo-admin#v1/' 'kengo-api#v1/'
