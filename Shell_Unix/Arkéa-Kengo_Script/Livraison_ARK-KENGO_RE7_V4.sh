...
function MepMaint(){
	...
	then
		...
		ssh ${USRAPP}@${SRVAPP1} 'cp -p /app/kengo-frontoffice/index.html /app/index.html-sav'
		ssh ${USRAPP}@${SRVAPP1} 'cp -p /app/kengo-frontoffice/so/index.html /app/index.html-so-sav'
	...
	then
		...
		cp -p /app/kengo-frontoffice/index.html /app/index.html-sav
		cp -p /app/kengo-frontoffice/so/index.html /app/index.html-so-sav
...
function SupMaint(){
	...
	then
		...
		ssh ${USRAPP}@${SRVAPP1} 'mv /app/index.html-sav /app/kengo-frontoffice/index.html'
		ssh ${USRAPP}@${SRVAPP1} 'mv /app/index.html-so-sav /app/kengo-frontoffice/so/index.html'
	elif [ $1 == "APP2" ]
	then
		echo " - Suppression de la page de maintenance sur ${SRVAPP2}"
		mv /app/index.html-sav /app/kengo-frontoffice/index.html
		mv /app/index.html-so-sav /app/kengo-frontoffice/so/index.html
	else
...
then
	echo " - ${SRVAPP2} :"
	StopTomcat APP2
	Pause "Verification Process Tomcat"
