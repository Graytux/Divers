#!/bin/bash
###########################################################################################  
# Nom : AR_ARKEA-KENGO_V1.sh                                                              #
# Description : Script servant a effectuer l'arret/Relance de Kengo                       #
...
MepMaint APP1
echo "Arret du service Tomcat sur le serveur ${SRVAPP2}"
StopTomcat APP2
echo "Suppression des fichiers Tomcat sur ${SRVAPP2}"
SupFicTomcat APP2
...
StopNginx APP1
echo "Arret du service Tomcat sur le serveur ${SRVAPP1}"
StopTomcat APP1
echo "Suppression des fichiers Tomcat sur ${SRVAPP1}"
SupFicTomcat APP1
